...
def good_ending():
    ...
    input(f'''                                                  After traveling for many years, you finally reach Proxima Centauri.\n                                   Having all of the special items granted you the ability to use your Auger to retrieve the energy.\n                                                   You make your journey back home and restore Earth back to normal.\n                                             Elon Musk is pleased, congratulations {bcolors.BOLD}{bcolors.OKGREEN}{player.name}{bcolors.ENDC}, you are now verified on Twitter!\n
{bcolors.OKCYAN}
:::     ::: :::::::::: :::::::::  ::::::::::: :::::::::: ::::::::::: :::::::::: :::::::::       :::::::::: :::    ::: :::::::::  :::        ::::::::  :::::::::  :::::::::: :::::::::       ::: 
:+:     :+: :+:        :+:    :+:     :+:     :+:            :+:     :+:        :+:    :+:      :+:        :+:    :+: :+:    :+: :+:       :+:    :+: :+:    :+: :+:        :+:    :+:      :+: 
+:+     +:+ +:+        +:+    +:+     +:+     +:+            +:+     +:+        +:+    +:+      +:+         +:+  +:+  +:+    +:+ +:+       +:+    +:+ +:+    +:+ +:+        +:+    +:+      +:+ 
...
def Trade():
        ...
        if player.location == planet_list[2]:
            if inventory[6].quantity == 0:
                print(f'5) 50x Space Tokens for 1x Energy Collection Auger')
                ...
                if userInput == 5:
                    if inventory[4].quantity >= 50:
                        if inventory[6].quantity == 0:
                            ...
                            inventory[4].quantity -= 50
                            y = False
                            input("Congrats, you have acquired a Special Item. \nThis Energy Collector Auger will help retrieve the energy from Proxima Centauri.")
                        else:
                            input('If you are not gonna make a trade, leave.')
                    else:
                        input('You do not have enough tokens')
...
class Player:
    def __init__(self,location, age = 80):
...
if __name__ == "__main__":
    ...
    sp_item_list = [Item('Suit'), Item('Energy Collection Auger'), Item('Warp Speed Upgrade'), Item('Advanced Ship')]

    inventory[3].quantity = 500
